 ...
 * @classDescription : Classe implémentant l'interface à impl�menter
 * @version 1.0
 */
...
public class ListeAssociativeChainee<C, E> implements IListeAssociative {
     ...
     *
     * instance of IListeAssociative | m�me nombre de clés | m�me taille | Toutes les clés ont les mêmes éléments
     *
     * @param autreListeAssociativeChainee L'objet � comparer
    ...
    public boolean ajouter(Object cle, Object element, int index) throws NullPointerException,
        ...
        if(cle == null){
            throw new NullPointerException("La cl� " + cle + " est null");
        }
        if(element == null){
            throw new NullPointerException("L'�l�ment " + element + " est null");
        }
    ...
    public boolean ajouter(Object cle, Object element) throws NullPointerException {
        ...
        //Cas si la cle n'existe pas
            ...
            nbrCles++;
            confirmation = true;
            this.ajouter(cle, element); //R�cursif car on vient d'ajouter la cl� � la chaine de cl�s
        }
    ...
    public boolean ajouter(Object cle, ArrayList listeElements, int index) throws NullPointerException,
        ...
        if(listeElements == null){
            throw new NullPointerException("La liste d'�l�ments" + listeElements + " est null");
        }else{
    ...
    public boolean modifier(Object cle, Object nouvelElement, int index) throws NullPointerException,
        ...
        //Cas o� la cl� n'existe pas ou que le nouvel element existe d�j�
        if(!this.cleExiste(cle)){
            confirmation = false;
    ...
    public boolean modifier(Object cle, ArrayList nouveauxElements) throws NullPointerException {
        ...
        if(nouveauxElements == null){
            throw new NullPointerException("L'array de nouveaux �l�ments " + nouveauxElements + " sont null");
        }
